            ...
            <table class="table table-striped table-hover table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge 
                                @if($purchase_request->status_berkas == 'proses') bg-warning 
                                @elseif($purchase_request->status_berkas == 'disetujui') bg-success 
                                @elseif($purchase_request->status_berkas == 'ditolak') bg-danger 
                                @endif
                                ">
                        ...
                        <td class="text-center d-flex justify-content-center gap-2">
                            ...
                            <a href="{{ route('approveperencanaan', ['id' => $purchase_request->id]) }}"
                                class="btn btn-sm btn-success" title="Approve">
                                <i class="ri-file-list-3-line"></i>
                            </a>
                            <a href="{{ route('rejectPerencanaan', ['id' => $purchase_request->id]) }}"
