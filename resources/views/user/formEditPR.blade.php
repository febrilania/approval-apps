...
<div class="main main-app p-3 p-lg-4">
    <div class="card shadow-sm p-lg-4">
        <div class="container">
            ...
            @endif
            <form action="{{ route('purchaseRequest.update.user', $purchaseRequest->id) }}" method="POST"
                ...
                <table class="table table-bordered" id="details-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Aksi -->
                            <td>
                                <a href="{{ route('purchaseRequest.deleteDetail.user', [$purchaseRequest->id, $detail->id]) }}"
