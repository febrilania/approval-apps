...
<head>
    ...
    <title>Wakil Rekotr 2 - Premium Dashboard Template</title>
    ...
    <div class="sidebar">
        ...
        <div id="sidebarMenu" class="sidebar-body">
            <div class="nav-group show">
                ...
                <ul class="nav nav-sidebar">
                    <li class="nav-item">
                        <a href="{{route('dashboardWarek')}}" class="nav-link"><i class="ri-dashboard-line"></i>
                    ...
                    <li class="nav-item">
                        <a href="{{route(PRwarek)}}" class="nav-link"><i class="ri-draft-line"></i>
                            <span>Request</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="sidebar-footer">
            ...
            <div class="sidebar-footer-menu" style="margin-bottom: 100px">
                <nav class="nav">
                    <a href="{{route('editProfileWarek')}}"><i class="ri-edit-2-line"></i> Edit Profile</a>
                    <a href="{{route('profileWarek')}}"><i class="ri-profile-line"></i> View Profile</a>
                </nav>
                <hr>
                <nav class="nav">
        ...
        <div class="dropdown dropdown-profile ms-3 ms-xl-4">
            ...
            <div class="dropdown-menu dropdown-menu-end mt-10-f">
                <div class="dropdown-menu-body">
                    ...
                    <nav class="nav">
                        <a href="{{route('editProfileWarek')}}"><i class="ri-edit-2-line"></i> Edit
                            Profile</a>
                        <a href="{{route('profileWarek')}}"><i class="ri-profile-line"></i> View Profile</a>
                    </nav>
                    <hr>
