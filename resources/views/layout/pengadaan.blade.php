        ...
        <div id="sidebarMenu" class="sidebar-body">
            <div class="nav-group show">
                ...
                <ul class="nav nav-sidebar">
                    <li class="nav-item">
                        <a href="{{route('dashboardPengadaan')}}" class="nav-link"><i class="ri-dashboard-line"></i>
                            <span>Dashboard</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('itemPengadaan')}}" class="nav-link"><i class="ri-store-2-line"></i>
                            <span>Item</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('PRpengadaan')}}" class="nav-link"><i class="ri-draft-line"></i>
                            <span>Request</span></a>
                    </li>
                    {{-- <li class="nav-item">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-footer-top">
                ...
                <div class="sidebar-footer-body">
                    <h6><a href="{{route('profilePengadaan')}}">{{Auth::user()->name}}</a></h6>
            ...
            <div class="sidebar-footer-menu" style="margin-bottom: 100px">
                <nav class="nav">
                    <a href="{{route('editProfilePengadaan')}}"><i class="ri-edit-2-line"></i> Edit
                        Profile</a>
                    <a href="{{route('profilePengadaan')}}"><i class="ri-profile-line"></i> View Profile</a>
                </nav>
                <hr>
                <nav class="nav">
    ...
    <div class="header-main px-3 px-lg-4">
        ...
        <div class="dropdown dropdown-profile ms-3 ms-xl-4">
            <a href="" class="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                <div class="avatar online"><img src="{{ asset('storage/items/'.Auth::user()->profile_picture) }}"
                        alt=""></div>
            </a>
            <div class="dropdown-menu dropdown-menu-end mt-10-f">
