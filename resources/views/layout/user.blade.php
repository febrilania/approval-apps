    ...
    <div class="sidebar">
        ...
        <div id="sidebarMenu" class="sidebar-body">
            <div class="nav-group show">
                ...
                <ul class="nav nav-sidebar">
                    <li class="nav-item">
                        <a href="{{route('dashboardUser')}}" class="nav-link"><i class="ri-dashboard-line"></i>
        ...
        <div class="sidebar-footer">
            ...
            <div class="sidebar-footer-menu" style="margin-bottom: 100px">
                <nav class="nav">
                    <a href="{{route('editProfileUser')}}"><i class="ri-edit-2-line"></i> Edit
                        Profile</a>
                    <a href="{{route('profileUser')}}"><i class="ri-profile-line"></i> View Profile</a>
                </nav>
                <hr>
                <nav class="nav">
