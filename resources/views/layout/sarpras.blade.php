        ...
        <div id="sidebarMenu" class="sidebar-body">
            <div class="nav-group show">
                ...
                <ul class="nav nav-sidebar">
                    <li class="nav-item">
                        <a href="{{route('dashboardSarpras')}}" class="nav-link"><i class="ri-dashboard-line"></i>
                            <span>Dashboard</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('itemSarpras')}}" class="nav-link"><i class="ri-store-2-line"></i>
                            <span>Item</span></a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="sidebar-footer">
            <div class="sidebar-footer-top">
                ...
                <div class="sidebar-footer-body">
                    <h6><a href="{{route('profileSarpras')}}">{{Auth::user()->name}}</a></h6>
            ...
            <div class="sidebar-footer-menu" style="margin-bottom: 100px">
                <nav class="nav">
                    <a href="{{route('editProfileSarpras')}}"><i class="ri-edit-2-line"></i> Edit
                        Profile</a>
                    <a href="{{route('profileSarpras')}}"><i class="ri-profile-line"></i> View Profile</a>
                </nav>
                <hr>
                <nav class="nav">
